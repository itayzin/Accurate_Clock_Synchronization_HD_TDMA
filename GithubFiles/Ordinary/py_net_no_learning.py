...
class node_aggregation():
    ...
    def prepare_data(self):
        ...
        # if nns.BIAS_CORRECTION_ENABLED:
        #     for node_indx in range(self.safedict["N"]):
        #         self.node_array[node_indx].estimate_correction_bias()
    ...
    def plot_connection(self):
        ...
        # Get the connection matrix and locations
        con_mat = self.connection_mat.detach().numpy()
        ...
        # Iterate over the two strength matrices
...
if __name__ == '__main__':
    ...
    logcell = {
        ...
        "Failed_Nodes" : list()}
    SIM_LEN = safedict["sim_length"] - 2
    modes = ["simeone","average_over_connections", "min_max_avg_neutralize"]
